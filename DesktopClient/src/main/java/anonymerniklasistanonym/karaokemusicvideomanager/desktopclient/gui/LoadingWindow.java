...
public class LoadingWindow {
	...
	public JFrame getInitWindow() {
		...
		// loadingFrame.setIconImage(new
		// ImageIcon(getClass().getResource("images/icons/about.png").getPath()).getImage());
		loadingFrame.setUndecorated(true);
		loadingFrame.setBackground(new Color(0f, 0f, 0f, 0f));

		Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
		loadingFrame.setLocation((int) ((screenBounds.getWidth() - 600) / 2),
				(int) ((screenBounds.getHeight() - 0) / 2));
