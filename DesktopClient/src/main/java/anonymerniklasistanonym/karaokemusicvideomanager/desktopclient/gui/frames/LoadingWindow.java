...
public class LoadingWindow {
	...
	public LoadingWindow(Stage hi) {
		this.setMainWindowStage(hi);
		createStage();
	}

	public LoadingWindow(Main hih) {
	...
	private String windowTitle = "Loading";
	...
	public void getValue() {
		System.out.println(pbs[0].getProgress());
	}

	public boolean getReady() {
		if (pbs[0].getProgress() == 100.0) {
			return true;
		}
