...
array_multisort($allTimestamps, SORT_ASC, SORT_NUMERIC, $allTitles, SORT_ASC, SORT_STRING, $allArtists, SORT_ASC, SORT_STRING, $allAuthors, SORT_ASC, SORT_STRING, $allData);
